...
class Ui_Application(QtWidgets.QMainWindow):
    ...
    # Importer les fonctions pour l'utilisation des boutons à l'intérieur de la def pour éviter la redondance
        import Fonctions
        ...
        self.lineFilm = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.lineFilm.setObjectName("lineFilm")
        self.lineFilm.setText("Titre du film")
        self.verticalLayout_22.addWidget(self.lineFilm)
