...
class QDomDocument(PySide6.QtXml.QDomNode):
    ...
    def nodeType(self) -> PySide6.QtXml.QDomNode.NodeType: ...
    @typing.overload
    def setContent(self, dev:PySide6.QtCore.QIODevice) -> typing.Tuple: ...
    @typing.overload
    def setContent(self, dev:PySide6.QtCore.QIODevice, namespaceProcessing:bool) -> typing.Tuple: ...
    @typing.overload
    def setContent(self, reader:PySide6.QtCore.QXmlStreamReader, namespaceProcessing:bool) -> typing.Tuple: ...
    @typing.overload
    def setContent(self, text:PySide6.QtCore.QByteArray) -> typing.Tuple: ...
    @typing.overload
    def setContent(self, text:PySide6.QtCore.QByteArray, namespaceProcessing:bool) -> typing.Tuple: ...
    @typing.overload
