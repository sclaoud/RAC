...
class Qt3DInput(Shiboken.Object):
    ...
    class QAbstractActionInput(PySide6.Qt3DCore.QNode): ...

    class QAbstractAxisInput(PySide6.Qt3DCore.QNode):
    ...
    class QAbstractPhysicalDevice(PySide6.Qt3DCore.QNode):
    ...
    class QAction(PySide6.Qt3DCore.QNode):
    ...
    class QActionInput(PySide6.Qt3DInput.QAbstractActionInput):
    ...
    class QAnalogAxisInput(PySide6.Qt3DInput.QAbstractAxisInput):
    ...
    class QAxis(PySide6.Qt3DCore.QNode):
    ...
    class QAxisAccumulator(PySide6.Qt3DCore.QComponent):
    ...
    class QAxisSetting(PySide6.Qt3DCore.QNode):
        ...
        def setAxes(self, axes:typing.Sequence) -> None: ...
        def setDeadZoneRadius(self, deadZoneRadius:float) -> None: ...
        def setSmoothEnabled(self, enabled:bool) -> None: ...

    class QButtonAxisInput(PySide6.Qt3DInput.QAbstractAxisInput):
    ...
    class QInputAspect(PySide6.Qt3DCore.QAbstractAspect):
    ...
    class QInputChord(PySide6.Qt3DInput.QAbstractActionInput):
    ...
    class QInputSequence(PySide6.Qt3DInput.QAbstractActionInput):
    ...
    class QInputSettings(PySide6.Qt3DCore.QComponent):
    ...
    class QKeyboardDevice(PySide6.Qt3DInput.QAbstractPhysicalDevice):
    ...
    class QKeyboardHandler(PySide6.Qt3DCore.QComponent):
    ...
    class QLogicalDevice(PySide6.Qt3DCore.QComponent):
    ...
    class QMouseDevice(PySide6.Qt3DInput.QAbstractPhysicalDevice):
    ...
    class QMouseHandler(PySide6.Qt3DCore.QComponent):
