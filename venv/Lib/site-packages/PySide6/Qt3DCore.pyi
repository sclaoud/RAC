...
class Qt3DCore(Shiboken.Object):
    ...
    class QAbstractAspect(PySide6.QtCore.QObject):
        ...
        def dependencies(self) -> typing.List: ...
    ...
    class QAbstractSkeleton(PySide6.Qt3DCore.QNode):
        def jointCount(self) -> int: ...

    class QArmature(PySide6.Qt3DCore.QComponent):
    ...
    class QAspectEngine(PySide6.QtCore.QObject):
        ...
        def lookupNodes(self, ids:typing.Sequence) -> typing.List: ...
    ...
    class QAttribute(PySide6.Qt3DCore.QNode):
        ...
        @typing.overload
        def __init__(self, buf:PySide6.Qt3DCore.Qt3DCore.QBuffer, name:str, vertexBaseType:PySide6.Qt3DCore.Qt3DCore.QAttribute.VertexBaseType, vertexSize:int, count:int, offset:int=..., stride:int=..., parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...
        @typing.overload
        def __init__(self, buf:PySide6.Qt3DCore.Qt3DCore.QBuffer, vertexBaseType:PySide6.Qt3DCore.Qt3DCore.QAttribute.VertexBaseType, vertexSize:int, count:int, offset:int=..., stride:int=..., parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...
        @typing.overload
        def __init__(self, parent:typing.Optional[PySide6.Qt3DCore.Qt3DCore.QNode]=...) -> None: ...
    ...
    class QBoundingVolume(PySide6.Qt3DCore.QComponent):
    ...
    class QBuffer(PySide6.Qt3DCore.QNode):
        ...
        def setData(self, bytes:PySide6.QtCore.QByteArray) -> None: ...
        def setUsage(self, usage:PySide6.Qt3DCore.Qt3DCore.QBuffer.UsageType) -> None: ...
        def updateData(self, offset:int, bytes:PySide6.QtCore.QByteArray) -> None: ...
        def usage(self) -> PySide6.Qt3DCore.Qt3DCore.QBuffer.UsageType: ...

    class QComponent(PySide6.Qt3DCore.QNode):
    ...
    class QEntity(PySide6.Qt3DCore.QNode):
    ...
    class QGeometry(PySide6.Qt3DCore.QNode):
    ...
    class QGeometryView(PySide6.Qt3DCore.QNode):
    ...
    class QJoint(PySide6.Qt3DCore.QNode):
        ...
        def setInverseBindMatrix(self, inverseBindMatrix:PySide6.QtGui.QMatrix4x4) -> None: ...
        def setName(self, name:str) -> None: ...
    ...
    class QSkeleton(PySide6.Qt3DCore.QAbstractSkeleton):
    ...
    class QSkeletonLoader(PySide6.Qt3DCore.QAbstractSkeleton):
    ...
    class QTransform(PySide6.Qt3DCore.QComponent):
