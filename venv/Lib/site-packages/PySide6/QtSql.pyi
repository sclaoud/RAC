...
class QSqlDatabase(Shiboken.Object):
    ...
    def tables(self, type:PySide6.QtSql.QSql.TableType=...) -> typing.List: ...
...
class QSqlDriver(PySide6.QtCore.QObject):
    ...
    def tables(self, tableType:PySide6.QtSql.QSql.TableType) -> typing.List: ...
...
class QSqlQuery(Shiboken.Object):
    ...
    @staticmethod
    def __copy__() -> None: ...
    def addBindValue(self, val:typing.Any, type:PySide6.QtSql.QSql.ParamType=...) -> None: ...
    def at(self) -> int: ...
    @typing.overload
    def bindValue(self, placeholder:str, val:typing.Any, type:PySide6.QtSql.QSql.ParamType=...) -> None: ...
    @typing.overload
    def bindValue(self, pos:int, val:typing.Any, type:PySide6.QtSql.QSql.ParamType=...) -> None: ...
    @typing.overload
...
class QSqlQueryModel(PySide6.QtCore.QAbstractTableModel):
    ...
    def beginInsertColumns(self, parent:PySide6.QtCore.QModelIndex, first:int, last:int) -> None: ...
    def beginInsertRows(self, parent:PySide6.QtCore.QModelIndex, first:int, last:int) -> None: ...
    def beginRemoveColumns(self, parent:PySide6.QtCore.QModelIndex, first:int, last:int) -> None: ...
    def beginRemoveRows(self, parent:PySide6.QtCore.QModelIndex, first:int, last:int) -> None: ...
    def beginResetModel(self) -> None: ...
    def canFetchMore(self, parent:PySide6.QtCore.QModelIndex=...) -> bool: ...
    def clear(self) -> None: ...
    def columnCount(self, parent:PySide6.QtCore.QModelIndex=...) -> int: ...
    def data(self, item:PySide6.QtCore.QModelIndex, role:int=...) -> typing.Any: ...
    def endInsertColumns(self) -> None: ...
    def endInsertRows(self) -> None: ...
    def endRemoveColumns(self) -> None: ...
    def endRemoveRows(self) -> None: ...
    def endResetModel(self) -> None: ...
    def fetchMore(self, parent:PySide6.QtCore.QModelIndex=...) -> None: ...
    def headerData(self, section:int, orientation:PySide6.QtCore.Qt.Orientation, role:int=...) -> typing.Any: ...
    def indexInQuery(self, item:PySide6.QtCore.QModelIndex) -> PySide6.QtCore.QModelIndex: ...
    def insertColumns(self, column:int, count:int, parent:PySide6.QtCore.QModelIndex=...) -> bool: ...
    def lastError(self) -> PySide6.QtSql.QSqlError: ...
    ...
    def removeColumns(self, column:int, count:int, parent:PySide6.QtCore.QModelIndex=...) -> bool: ...
...
class QSqlRelationalDelegate(PySide6.QtWidgets.QStyledItemDelegate):
    ...
    def __init__(self, aParent:typing.Optional[PySide6.QtCore.QObject]=...) -> None: ...

    def createEditor(self, aParent:PySide6.QtWidgets.QWidget, option:PySide6.QtWidgets.QStyleOptionViewItem, index:PySide6.QtCore.QModelIndex) -> PySide6.QtWidgets.QWidget: ...
    def setEditorData(self, editor:PySide6.QtWidgets.QWidget, index:PySide6.QtCore.QModelIndex) -> None: ...
    def setModelData(self, editor:PySide6.QtWidgets.QWidget, model:PySide6.QtCore.QAbstractItemModel, index:PySide6.QtCore.QModelIndex) -> None: ...
...
class QSqlRelationalTableModel(PySide6.QtSql.QSqlTableModel):
    ...
    def __init__(self, parent:typing.Optional[PySide6.QtCore.QObject]=..., db:PySide6.QtSql.QSqlDatabase=...) -> None: ...
    ...
    def setData(self, item:PySide6.QtCore.QModelIndex, value:typing.Any, role:int=...) -> bool: ...
...
class QSqlTableModel(PySide6.QtSql.QSqlQueryModel):
    ...
    def clear(self) -> None: ...
    def clearItemData(self, index:PySide6.QtCore.QModelIndex) -> bool: ...
    def data(self, idx:PySide6.QtCore.QModelIndex, role:int=...) -> typing.Any: ...
    ...
    def insertRowIntoTable(self, values:PySide6.QtSql.QSqlRecord) -> bool: ...
    def insertRows(self, row:int, count:int, parent:PySide6.QtCore.QModelIndex=...) -> bool: ...
    @typing.overload
    def isDirty(self) -> bool: ...
    @typing.overload
    def isDirty(self, index:PySide6.QtCore.QModelIndex) -> bool: ...
    def orderByClause(self) -> str: ...
