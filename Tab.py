...
#### DÉBUT DE LA TAB PERSONNE ####
    ...
    # Lineedit contenant le Prenom de la personne
        ...
        self.linePrenom.setText(str("Martin"))
...
#### DEBUT DE LA TAB FILMS ####
    ...
    # Lineedit avec la catégorie du film
        self.lineCatFilm = QtWidgets.QLineEdit(self.verticalLayoutWidget_4)
        self.lineCatFilm.setObjectName("lineCatFilm_2")
        self.verticalLayout_22.addWidget(self.lineCatFilm)
...
#### Fonctions des classes ####
 ...
 ### Enregistrement de l'entré et remise à zero ### En cours
    def NewEntrie(self):
        Personne.set_sexe()
